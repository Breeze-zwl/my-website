...
import { formatTime } from '@/utils/DailyGetCurrentTime'
...
console.log(lastClickTime.value, `${props.hotType}Btn`, props.hotType)

// 热榜数据
const hotListData = ref(null)
const scrollbarRef = ref(null)
const listLoading = ref(false)
console.log('0-0-0-0-0-0-0-0-', props.hotType)
// 获取热榜数据
